...
describe('plist', () => {
  describe('generatePlist', () => {
    ...
    test('includes StandardOutPath and StandardErrorPath', () => {
      ...
      expect(xml).toContain('<string>/var/log/idea-storage/com.idea-storage.test-stdout.log</string>')
      expect(xml).toContain('<key>StandardErrorPath</key>')
      expect(xml).toContain('<string>/var/log/idea-storage/com.idea-storage.test-stderr.log</string>')
    })
